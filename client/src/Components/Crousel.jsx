        ...
        <Carousel fade>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption id='crousel-caption'>
              <h3 style={{ color: "#bb2d3b" }}>Buy Premium Watches</h3>
              <p style={{ color: "#bb2d3b" }}>Buy our premium watches</p>
          ...
          <Carousel.Item>
            ...
            />
            <Carousel.Caption id='crousel-caption'>
              <h3 style={{ color: "#bb2d3b" }}>Reno 12 Pro 5G</h3>
              <p style={{ color: "#bb2d3b" }}>Your every day AI companion</p>
              <Button variant="primary">More Info →</Button>
            </Carousel.Caption>
          </Carousel.Item>
          ...
          <Carousel.Item >
            ...
            />
            <Carousel.Caption id='crousel-caption'>
              <h3 style={{ color: "#bb2d3b" }}>Vivo V40 | Vivo V40 Pro</h3>
              <p style={{ color: "#bb2d3b" }}>ZEISS Portrait SO Pro</p>
              <Button variant="primary">More Info →</Button>
            </Carousel.Caption>
          </Carousel.Item>
          {/* keyboards */}
          <Carousel.Item >
            ...
            />
            <Carousel.Caption id='crousel-caption'>
              <h3 style={{ color: "#bb2d3b" }}>Our Premium Keyboard</h3>
              <p style={{ color: "#bb2d3b" }}>Buy our premium keyboards of 20% discount</p>
              <Button variant="primary">More Info →</Button>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item >
            ...
            />
            <Carousel.Caption id='crousel-caption'>
              <h3 style={{ color: "#bb2d3b" }}>Our Premium Laptops</h3>
              <p style={{ color: "#bb2d3b" }}>Buy our premium laptop macbook, ipad</p>
              <Button variant="primary">More Info →</Button>
            </Carousel.Caption>
          </Carousel.Item>
